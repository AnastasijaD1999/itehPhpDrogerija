    ...
    <nav class="navbar navbar-expand nav-color ">
        <div class="container">
            <div class="nav navbar-nav">
                <a class="nav-item nav-link" href="proizvodi.php">Proizvodi<span class="visually-hidden">(current)</span></a>
                <a class="nav-item nav-link" href="korpa.php">Korpa <span id="broj_proizvoda"></span></a>
                <a class="nav-item nav-link active" href="provera_porudzbine.php">Provera porudzbine</a>
            </div>
        </div>
    </nav>
