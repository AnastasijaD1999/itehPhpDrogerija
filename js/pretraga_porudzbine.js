$(document).ready(function () {
    ...
    $('body').on('click', '.obrisi', function () {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost/drogerija/api/obrisi_porudzbinu.php",
            data: {
                porudzbina_id: id
            },
            dataType: "text",
    ...
    function ucitajPorudzbine() {
        $.ajax({
            type: "GET",
            url: "http://localhost/drogerija/api/porudzbine_po_korisniku.php?korisnik_email=" + $('#search-email-input').val(),
            dataType: "JSON",
